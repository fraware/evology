...
% INET Complexity (@INET_Complexity) a tweeté : New research by @y_m_asano, @JakobKolb, Jobst Heitzig and Doyne Farmer shows that key insights into economic phenomena can be missed if we assume people are rational decision-makers rather than deeply social beings
% https://t.co/X1ZXjOcMIb
% https://twitter.com/INET_Complexity/status/1412414853084594179?s=20
