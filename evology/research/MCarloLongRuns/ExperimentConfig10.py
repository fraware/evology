...
TimeHorizon = 252 * 400 + 3 * 21 # 100 Years + 3 months to compensate early period without recording data.
PopulationSize = 100
...
if __name__ == '__main__':
    ...
    dfNT.to_csv("data_config10/MC_NT.csv")
    dfVI.to_csv("data_config10/MC_VI.csv")
    dfTF.to_csv("data_config10/MC_TF.csv")