# -*- coding: utf-8 -*-
"""
Created on Mon Jun  7 15:30:09 2021
...
class Representation:
    ...
    def __init__(
        self, initialize, decoder=IdentityDecoder(), individual_cls=Individual
    ):
    ...
    def create_population(self, pop_size, problem):
        ...
        """
        return self.individual_cls.create_population(
            pop_size, initialize=self.initialize, decoder=self.decoder, problem=problem
        )
