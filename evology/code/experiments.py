...
def MC_LongRunsWS(Reps:int, InitialCondition:list, Time:int, PopSize:int, ProbaSelection, ProbaMutation):
    ...
    for i in tqdm(range(Reps)):
        ...
        df, pop = main(mode, space, solver, circuit, Time, ProbaSelection, PopSize, ProbaMutation, 
            InitialCondition, tqdm_display, reset_wealth)
