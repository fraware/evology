...
data_return[0,:] = complete(returns1, n)
data_return[1,:] = complete(returns2, n)

print(data_return)
print(np.mean(data_return))
print(np.nanmean(data_return))
print(np.nanmean(returns1))
