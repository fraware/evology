...
wealth_coordinates = [0.009518668605608948, 0.3448114640215178, 0.6456698673728732]
...
df = run(100, 0, 100, wealth_coordinates, tqdm_display=False, reset_wealth=False)
