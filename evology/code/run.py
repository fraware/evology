...
wealth_coordinates = [0.2646631077422079, 0.17726102645095207, 0.55807586580684]
...
df,pop = run(30, 3, 252 * 10, wealth_coordinates, tqdm_display=False, reset_wealth=False)
