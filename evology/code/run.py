...
wealth_coordinates = [0.5818129359010346, 0.19708322475659765, 0.22110383934236777]
...
df,pop = run(50, 1, 252 * 20, wealth_coordinates, tqdm_display=False, reset_wealth=False)
